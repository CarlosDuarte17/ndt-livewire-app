<nav class="sticky top-0 left-0 w-full z-10 bg-slate-800 md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
...
{{--        </form>--}}
        <ul class="flex-col md:flex-row list-none items-center hidden md:flex">
            ...
            <div class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg min-w-48" id="user-dropdown">
              <a href="#" class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700">Profile</a>
              <div class="h-0 my-2 border border-solid border-blueGray-100"></div>
              <a href="#" class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700">Logout</a>
            </div>
        </ul>
    </div>
</nav>
