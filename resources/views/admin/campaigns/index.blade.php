  ...
  <main>
    <div class="p-4 bg-white block sm:flex items-center justify-between lg:mt-1.5 lg:pt-28">
      <div class="mb-1 w-full">
        <div class="mb-4">
          <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All campaigns</h1>
        </div>
        <div class="sm:flex">
          <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
            ...
            <div class="flex items-center gap-2">
              ...
              <label for="checkbox-all">Public</label>
            </div>
          </div>
          ...
          <div class="shadow overflow-hidden">
            <table class="table-fixed min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">September Nerdify Dev Talks</td>
                <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore, nemo.</td>
