<x-app-layout>
  <main>
    <section class="flex flex-col lg:flex-row pt-20 px-4">
      <div class="h-[200px] overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch lg:h-auto">
        <h2 class="font-bold text-xl">Contacts</h2>
        <ul>
          <li class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
      ...
      <div class="flex-1 p:2 sm:p-6 flex flex-col h-[800px] border-l border-gray-100">
          ...
          <div class="relative flex items-center space-x-4">
            ...
            <div class="flex flex-col leading-tight">
              <div class="text-2xl mt-1 flex items-center">
                <span class="text-gray-700 mr-3">Neil Sims</span>
              </div>
        ...
        <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0 mt-auto">
