          ...
          <div>
            <form action="#" class="space-y-6" x-show="currentTab === 0" x-transition.duration.200ms>
              <div>
                ...
                <input type="text" name="name" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Bonnie">
              </div>
              <div>
                <label for="position" class="text-sm font-medium text-gray-900 block mb-2">Position</label>
                <input type="text" name="position" id="position" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Developer">
              </div>
              <div>
            ...
            <form action="#" class="space-y-6" x-show="currentTab === 1" x-transition.duration.500ms>
              ...
              <div>
                <label for="password_confirmation" class="text-sm font-medium text-gray-900 block mb-2">Password Confirmation</label>
